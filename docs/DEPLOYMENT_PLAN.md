...
- **Includes**: App + Prometheus + Grafana + Redis (optional)

### **Option 2: Docker (Production Single Server)**
- **Time**: 10-15 minutes
- **Complexity**: Medium
...
**Which deployment option would you like to use?**

1. **Docker Compose** (Easiest, recommended for testing)
2. **Docker** (Single server production)
