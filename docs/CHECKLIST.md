...
- [x] docs/DOCKER.md with build and deployment instructions
- [x] docs/MONITORING.md with Prometheus queries and dashboards
- [x] docs/KUBERNETES.md with K8s deployment guide
- [x] docs/PERFORMANCE.md with SLO targets and tuning
- [x] docs/SECURITY.md with hardening checklist
...
- [docs/KUBERNETES.md](KUBERNETES.md) - Kubernetes guide
